...
public class PrometheusClientTest {
    ...
    public void testQueryRangeResponse() {
        prometheusClient.queryRange("up", "2020-12-22T20:10:30.781Z", "2020-12-23T20:11:00.781Z", "15s");
        verify(httpClient).doGet(eq("http://localhost:9090/api/v1/query_range?query=up&start=2020-12-22T20%3A10%3A30.781Z&end=2020-12-23T20%3A11%3A00.781Z&step=15s"));
    }
